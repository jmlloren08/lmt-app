                ...
                <div className="flex w-full max-w-6xl bg-white shadow-lg">
                    ...
                    <div className="w-full xl:w-1/2 flex justify-center items-center p-10">
                        <div className="w-full max-w-md">
                            ...
                            <span className="mb-3 block font-small">Enter your email address to receive a password reset link.</span>
                            ...
                            <form onSubmit={submit}>
                                ...
                                <div className="mb-3">
                                    <input
                                        type="submit"
                                        value={processing ? 'Processing...' : 'Send Password Reset Link'}
